---
name: tarot
description: "A reflective tarot draw for insight, decision support, and future-oriented reflection (presence-first, non-clinical, non-predictive)."

when:
  - "User asks to draw tarot / draw a card / tarot reading"
  - "User asks about the future, possible outcomes, or what might happen"
  - "User is making a decision and seeks clarity between options"
  - "User feels uncertain, stuck, overwhelmed, or at a crossroads"
  - "User asks for guidance, direction, meaning, or perspective"
  - "User wants help reflecting on relationships, career, life path, or major choices"
---

# Tarot Draw (Reflective Skill)
